   ...
   <Grid container direction='row' justifyContent='center' alignItems='center'>
        ...
        <Box paddingX={20}>
                 <form onSubmit={cadastrar}>
                        ...
                        <TextField value={confirmarSenha} onChange={(e:ChangeEvent<HTMLInputElement>) => confirmarSenhaHandle(e)} className="cor" id='confirmarSenha' label='Confirmar Senha' variant='outlined' name='confirmarSenha' margin='normal' type='password'fullWidth />
